...
- `014`: deletes retired future-trip and regular-area records/tables, prunes provider regular corridors deterministically to two, and installs the database-level maximum-two corridor guard.
...
- Provider current-capacity, maximum-two regular-corridor, profile, fleet, and verification commands.
