...
2. Apply/lint migrations `001`–`047` in staging, verify RLS/RPC behavior including concurrent request limits, import place data, and rehearse encrypted logical backup/restore.
