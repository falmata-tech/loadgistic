...
2. Apply/lint migrations `001`–`048` in staging, verify RLS/RPC behavior including concurrent request limits and private-quarantine isolation, import place data, and rehearse encrypted logical backup/restore.
