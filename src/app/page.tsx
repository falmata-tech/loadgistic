...
export const metadata:Metadata={title:'Open Transport Capacity',description:'Find truck capacity shared by transporters across Ethiopia. Connect directly for the goods you ship or receive.'};
...
export default async function HomePage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}) {
  ...
  return <><PublicHeader/><main className="public-app-page public-market-workspace">
    <h1 className="sr-only"><Text message="Open Transport Capacity"/></h1>
