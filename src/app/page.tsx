      ...
      <section className="section member-preview-section">
        <div className="container">
          ...
          <div className="market-preview-grid">
            ...
            <article className="market-preview-panel"><div className="preview-truck"><Image src="/vehicle-configurations/light-stake-body-truck.jpg" alt="Light stake body truck" width={180} height={180}/><div><span className="status green">Partial · 40%</span><h3>Isuzu NPR · open capacity</h3></div></div><dl><div><dt>Current area</dt><dd>Around Addis Ababa, Ethiopia · privacy protected</dd></div><div><dt>Current route</dt><dd>Addis Ababa, Ethiopia → Hawassa, Ethiopia</dd></div><div><dt>Accepting</dt><dd>FTL + PTL · direct only</dd></div></dl></article>
        ...
        <div className="container transporter-value-grid">
          <div>
            ...
            <div className="transport-outcomes">
              <div><Truck aria-hidden="true"/><span><strong>Fleet transporters</strong><small>Manage the full roster, compare Preferred Routes with Business locations, and update each truck from My Fleet.</small></span></div>
