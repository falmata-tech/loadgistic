...
export default async function FleetPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
 ...
 return <div className="page"><PageHeader title="My Fleet" subtitle="Manage every registered truck and open one truck at a time to update capacity."/>
