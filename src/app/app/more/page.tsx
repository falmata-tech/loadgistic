...
export default async function AccountPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
  ...
  return <div className="page account-page"><PageHeader icon={CreditCard} title={<Text message="Account & plan"/>} subtitle={<Text message="Your account details and workspace access."/>}/><Flash error={query.error} success={query.success}/><div className="two-col account-layout"><div className="stack account-primary-stack">
