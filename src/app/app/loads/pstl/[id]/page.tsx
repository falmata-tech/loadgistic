...
import { getPooledLoad } from '@/lib/repository.js';
import { PageHeader } from '@/components/page-header';
import { priceDisplay } from '@/lib/ui';

export default async function PooledLoadPage({params}:{params:Promise<{id:string}>}){
  ...
  return <div className="page">
    ...
    <div className="stack">
      {pool.members.map((load:any)=><article className="card pooled-member" key={load.id}>
