  ...
  return <div className="page">
    ...
    <div className="two-col">
      ...
      <aside className="stack">
        <section className="card"><h3>Transporter</h3><p><strong>{ownerName}</strong></p><div className="meta">{capacity.organization_name ? 'Fleet transporter' : 'Self-managed driver'}</div>{ownerHandle?<Link className="button secondary" href={`/companies/${ownerHandle}`}>View Public Profile</Link>:null}</section>
