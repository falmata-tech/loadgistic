...
export default async function CapacityPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
 ...
 <form className="board-filter-panel" method="get">
   ...
   <div className="board-filter-grid">
     ...
     <div className="form-group"><label htmlFor="capacity-origin">Route city 1</label><EthiopiaPlaceInput id="capacity-origin" name="origin" defaultValue={filters.origin} placeholder="Addis Ababa, Ethiopia"/></div>
     <div className="form-group"><label htmlFor="capacity-destination">Route city 2</label><EthiopiaPlaceInput id="capacity-destination" name="destination" defaultValue={filters.destination} placeholder="Hawassa, Ethiopia"/></div>
