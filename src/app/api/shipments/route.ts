...
export async function POST(request: NextRequest) {
  ...
  try {
    const result = createShipment(user, {
      ...
      movementScope:text(form,'movementScope')||'INTERCITY',
      origin: text(form,'origin'),
      originPlaceRef:text(form,'originPlaceRef'),
      destination: text(form,'destination'),
      destinationPlaceRef:text(form,'destinationPlaceRef'),
      localPlaceRef:text(form,'localPlaceRef'),
      localPlaceLabel:text(form,'localPlaceLabel'),
      pickupAreaLabel:text(form,'pickupAreaLabel'),
      dropoffAreaLabel:text(form,'dropoffAreaLabel'),
      pickupLat:text(form,'pickupLat'),
      pickupLng:text(form,'pickupLng'),
      dropoffLat:text(form,'dropoffLat'),
      dropoffLng:text(form,'dropoffLng'),
