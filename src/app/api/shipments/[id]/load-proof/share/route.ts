...
export async function POST(request:NextRequest,{params}:{params:Promise<{id:string}>}) {
  ...
  try { await shareLoadProof(user,id,text(form,'interestId'),form.get('file'),text(form,'note')); return redirectWith(request,`/app/shipments/${id}`,'success','Shipment proof shared temporarily.'); }
