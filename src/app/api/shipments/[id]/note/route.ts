...
import { addShipmentNote } from '@/lib/repository.js';
...
export async function POST(request:NextRequest,{params}:{params:Promise<{id:string}>}){
 ...
 try{addShipmentNote(user,id,text(form,'note'));return redirectWith(request,`/app/shipments/${id}`,'success','Internal note saved.');}
