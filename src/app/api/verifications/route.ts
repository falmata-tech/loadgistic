...
export async function POST(request:NextRequest) {
  ...
  try {
    ...
    submitVerification(user,{subjectType:text(form,'subjectType'),subjectId:text(form,'subjectId'),verificationType:text(form,'verificationType'),documentName:text(form,'documentName')},upload);
