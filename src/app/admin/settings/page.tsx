...
export default async function PlatformSettingsPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
  ...
  return <div className="page platform-settings-page"><PageHeader icon={Settings2} title="Settings" subtitle="Platform access controls."/><Flash error={query.error} success={query.success}/><AccessControlsForm controls={controls}/></div>;
}
