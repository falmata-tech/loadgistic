const FEATURED_TRUCK_DAYS=Object.freeze([
  ...
  {key:'heavy-rigid',label:'Heavy rigid trucks',shortLabel:'Heavy rigid',configurations:['Heavy Rigid Stake Body Truck']},
  {key:'heavy-trailer',label:'Heavy trucks with trailers',shortLabel:'Trailers',configurations:['Heavy Rigid Stake Body Truck + Trailer']}
]);
