const messages: Record<string,string> = {
  ...
  INVALID_EMAIL: 'Enter a valid shipper and receiver email address.',
  ...
  REVIEW_NOT_ALLOWED: 'Only the verified shipper can review a provider within 30 days of completion.',
