...
export function DriverCapacityHome({ user, vehicles, capacities, query }: { user: any; vehicles: any[]; capacities: any[]; query: Record<string,string|undefined> }) {
  ...
  return <div className="page capacity-home-page">
    <PageHeader title={isDriver ? 'My capacity' : 'Driver capacity'} subtitle="Keep your truck's live market signal accurate, useful, and current."/>
