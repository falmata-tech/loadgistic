...
export function ShipmentForm({
  ...
  return <form action="/api/shipments" method="post" className="load-composer stack" data-testid="new-shipment-form">
    ...
    <section className="load-composer-section">
      <div className="load-step-heading"><span>1</span><PackageOpen aria-hidden="true"/><div><h2>Shipment</h2><p>What is moving?</p></div></div>
    ...
    <section className="load-composer-section">
      <div className="load-step-heading"><span>2</span><Route aria-hidden="true"/><div><h2>Route and dates</h2><p>Where and when?</p></div></div>
      <div className="form-grid">
        <fieldset className="form-group full"><legend><Route aria-hidden="true"/>Movement</legend><div className="rich-choice-grid two"><label className="rich-choice"><input type="radio" name="movementScope" value="LOCAL" checked={movementScope==='LOCAL'} onChange={()=>setMovementScope('LOCAL')}/><MapPin aria-hidden="true"/><span><strong>Local</strong><small>One city, town, or nearby area</small></span><Check className="choice-check" aria-hidden="true"/></label><label className="rich-choice"><input type="radio" name="movementScope" value="INTERCITY" checked={movementScope==='INTERCITY'} onChange={()=>setMovementScope('INTERCITY')}/><Route aria-hidden="true"/><span><strong>Long-distance routes</strong><small>Travel beyond the local working area</small></span><Check className="choice-check" aria-hidden="true"/></label></div></fieldset>
    ...
    <section className="load-composer-section">
      <div className="load-step-heading"><span>4</span><Share2 aria-hidden="true"/><div><h2>Who can see it?</h2><p>Choose the transporters you want to reach.</p></div></div>
      <div className="form-grid">
