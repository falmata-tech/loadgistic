...
export function BoardGeographyFilters({
  ...
  return <>
    ...
    {movementScope==='LOCAL'?<div className="form-group full">
      ...
      <label htmlFor={`${idPrefix}-local-radius`}>Match within</label>
    ...
    {movementScope==='INTERCITY'?<>
      <div className="form-group">
        ...
        <label htmlFor={`${idPrefix}-origin-radius`}>Origin radius</label>
      ...
      <div className="form-group">
        <label htmlFor={`${idPrefix}-destination`}><Route aria-hidden="true"/>{routeLabels[1]}</label>
        ...
        <label htmlFor={`${idPrefix}-destination-radius`}>Destination radius</label>
      ...
      <fieldset className="form-group full">
        <legend><Route aria-hidden="true"/>Direction</legend>
