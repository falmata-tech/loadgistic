...
| `FEAT-SHP-001` | Load posting, searchable and truck-ranked Load Board, party-only Tracking, visual truck choice, deadlines, designated phone, receiver contact, and Business ratings | Shipment aggregate, explainable endpoint matching, discovery/execution query split, staged contact disclosure, participant reviews, and transitions | Durable DB, audit | domain, repository, authorization, E2E |
| `FEAT-CAP-001` | Self-managed Driver Home, Fleet-based company capacity controls, truck detail, paired corridor cities, and searchable Capacity Board | Duty state, authoritative vehicle rows, explainable endpoint matching, Empty/Partial percentage, accepted loads, obscured device area, freshness, contract lanes, proof context, relationship scope | Expiry clock, geolocation permission, private upload storage | domain, repository, authorization, E2E |
| `FEAT-PRV-001` | Authenticated Directory, Public Profiles, declared Business regions, fleet network coverage, ratings, fleet roster, and explicit public contacts | Visibility, ownership, member-entered regions, coverage projection, rating summaries, and vehicle-derived fleet counts | Authenticated-field review | repository, authorization, E2E |
